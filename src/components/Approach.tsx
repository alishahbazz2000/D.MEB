...
const Approach = () => {
    return (
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4 leading-8">
                <Card
                    title="مهارت اول"
                    icon={<AceternityIcon order="مهارت اول"/>}
                ...
                <Card
                    title="مهارت دوم"
                    icon={<AceternityIcon order="مهارت دوم"/>}
                    des="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد کتابهای زیادی در شصت و سه درصد گذشته حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد"
                ...
                <Card
                    title="مهارت سوم"
                    icon={<AceternityIcon order="مهارت سوم"/>}
                    des="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد کتابهای زیادی در شصت و سه درصد گذشته حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد"
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
    ...
    return (
        <div
            ...
            className="border  group/canvas-card flex items-center justify-center
                        border-white/[0.2]  max-w-sm w-full mx-auto p-4 relative lg:h-[35rem] rounded-3xl leading-9"
            style={{
            ...
            <div className="relative z-20 px-10">
                ...
                <p
                    className="text-sm opacity-0 group-hover/canvas-card:opacity-100
                                ...
                                group-hover/canvas-card:-translate-y-2 transition duration-200 leading-8"
                    style={{color: "#E4ECFF"}}
                >
                    {des}
                </p>
